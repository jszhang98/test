package production.test.thinkinginjava.containerindepth;//: containers/SpringDetector.java
// What will the weather be?
import production.test.thinkinginjava.containerindepth.Groundhog;
